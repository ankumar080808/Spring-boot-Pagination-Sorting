package com.anant.SpringbootPagination_Sorting;
...
import com.anant.SpringbootPagination_Sorting.DTO.APIResponse;
import com.anant.SpringbootPagination_Sorting.Entity.Product;
import com.anant.SpringbootPagination_Sorting.Service.ProductService;
...
public class SpringbootPaginationSortingApplication {
	  ...
	  @GetMapping
	    private APIResponse<List<Product>> getProducts() {
	        ...
	        return new APIResponse<List<Product>>(allProducts.size(), allProducts);
	    }
